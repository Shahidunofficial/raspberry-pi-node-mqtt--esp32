...
const char* mqtt_server = "#########################.hivemq.cloud"; // replace with your HiveMQ Cluster URL
const char* mqtt_username = "user"; // replace with your Username
...
void setup_wifi() {
  ...
  randomSeed(micros()); //to genrate random numbers
...
//function to handle the messeges from server
